...
/***/ "./src/controllers/orders/DELETE/index.js":
/*!************************************************!*\
  !*** ./src/controllers/orders/DELETE/index.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dbActions_orders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../dbActions/orders */ \"./src/dbActions/orders.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n\n    const { params: { orderId } } = req;\n\n    Object(_dbActions_orders__WEBPACK_IMPORTED_MODULE_0__[\"orderDelete\"])(orderId)\n        .then(result => {\n            if (result.deletedCount > 0) {\n                res.status(200).json({\n                    message: 'success',\n                });\n            } else {\n                res.status(404).json({\n                    message: 'Not Found',\n                });\n            }\n        })\n        .catch(error => {\n            res.status(404).json({ error });\n            throw new Error(error);\n        });\n});\n\n//# sourceURL=webpack:///./src/controllers/orders/DELETE/index.js?");

/***/ }),

/***/ "./src/controllers/orders/GET/index.js":
/*!*********************************************!*\
  !*** ./src/controllers/orders/GET/index.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dbActions_orders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../dbActions/orders */ \"./src/dbActions/orders.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n    Object(_dbActions_orders__WEBPACK_IMPORTED_MODULE_0__[\"orderFindAll\"])()\n        .then(result => {\n            res.status(200).json(result);\n        })\n        .catch(error => {\n            next(error);\n        });\n});\n\n\n//# sourceURL=webpack:///./src/controllers/orders/GET/index.js?");

/***/ }),

/***/ "./src/controllers/orders/GET_BY_ID/index.js":
/*!***************************************************!*\
  !*** ./src/controllers/orders/GET_BY_ID/index.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dbActions_orders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../dbActions/orders */ \"./src/dbActions/orders.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n    const { params: { orderId } } = req;\n    Object(_dbActions_orders__WEBPACK_IMPORTED_MODULE_0__[\"orderFindById\"])(orderId)\n        .then(result => {\n            res.status(200).json(result);\n        })\n        .catch(error => {\n            res.status(404).json({\n                message: 'Not found',\n            });\n            throw new Error(error);\n        });\n});\n\n//# sourceURL=webpack:///./src/controllers/orders/GET_BY_ID/index.js?");

/***/ }),

/***/ "./src/controllers/orders/PATCH/index.js":
/*!***********************************************!*\
  !*** ./src/controllers/orders/PATCH/index.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dbActions_orders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../dbActions/orders */ \"./src/dbActions/orders.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n    const { body } = req;\n\n    const orderObject = {};\n\n    Object.keys(body).forEach(key => {\n        orderObject[`${key}`] = body[key];\n    });\n\n    Object(_dbActions_orders__WEBPACK_IMPORTED_MODULE_0__[\"orderUpdate\"])(body._id, orderObject)\n        .then(result => {\n            orderFindById(body._id).then(data => {\n                res.status(200).json(data);\n            });\n        })\n        .catch(error => {\n            next(error);\n        });\n});\n\n//# sourceURL=webpack:///./src/controllers/orders/PATCH/index.js?");

/***/ }),

/***/ "./src/controllers/orders/POST/index.js":
/*!**********************************************!*\
  !*** ./src/controllers/orders/POST/index.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dbActions_orders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../dbActions/orders */ \"./src/dbActions/orders.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n\n    const { body } = req;\n\n    const payload = {\n        ...body,\n        product: body.product._id,\n    };\n    /**\n     * @see\n     * bad practice, used to search product id while\n     * saving and replacing it with product object\n     * right while creating, but seems to be ok if you\n     * don't want to hit database every time you call\n     * the order object\n     */\n    // productFindById(body.product._id)\n    //     .then(product => {\n    //         const payload = {\n    //             _id: Types.ObjectId(),\n    //             ...body,\n    //             product,\n    //         };\n    //         let entity = null;\n    //         if (product) {\n    //             entity = orderSave(payload);\n    //         }\n    //         return entity;\n    //     })\n    //     .then(result => {\n    //         res.status(201).json(result);\n    //     })\n    Object(_dbActions_orders__WEBPACK_IMPORTED_MODULE_0__[\"orderSave\"])(payload)\n        .then(result => {\n            res.status(201).json(result);\n        })\n        .catch(error => {\n            next(error);\n        });\n});\n\n//# sourceURL=webpack:///./src/controllers/orders/POST/index.js?");

/***/ }),

/***/ "./src/controllers/orders/index.js":
/*!*****************************************!*\
  !*** ./src/controllers/orders/index.js ***!
  \*****************************************/
/*! exports provided: getController, postController, patchController, getByIdController, deleteController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _GET__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GET */ \"./src/controllers/orders/GET/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"getController\", function() { return _GET__WEBPACK_IMPORTED_MODULE_0__[\"default\"]; });\n\n/* harmony import */ var _POST__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./POST */ \"./src/controllers/orders/POST/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"postController\", function() { return _POST__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n/* harmony import */ var _PATCH__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PATCH */ \"./src/controllers/orders/PATCH/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"patchController\", function() { return _PATCH__WEBPACK_IMPORTED_MODULE_2__[\"default\"]; });\n\n/* harmony import */ var _GET_BY_ID__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GET_BY_ID */ \"./src/controllers/orders/GET_BY_ID/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"getByIdController\", function() { return _GET_BY_ID__WEBPACK_IMPORTED_MODULE_3__[\"default\"]; });\n\n/* harmony import */ var _DELETE__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DELETE */ \"./src/controllers/orders/DELETE/index.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"deleteController\", function() { return _DELETE__WEBPACK_IMPORTED_MODULE_4__[\"default\"]; });\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./src/controllers/orders/index.js?");
...
/***/ "./src/middlewares/o-auth/userAuth.js":
/*!********************************************!*\
  !*** ./src/middlewares/o-auth/userAuth.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jsonwebtoken */ \"jsonwebtoken\");\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jsonwebtoken__WEBPACK_IMPORTED_MODULE_0__);\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ((req, res, next) => {\n    try {\n        const token = req.headers.authorization.split(\" \")[1];\n        const decoded = jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default.a.verify(token, process.env.JWT_KEY);\n        req.userData = decoded;\n        console.log(req.userData);\n        next();\n    } catch (error) {\n        throw new Error('Unauthorised');\n    }\n});\n\n\n//# sourceURL=webpack:///./src/middlewares/o-auth/userAuth.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../middlewares/o-auth/userAuth */ \"./src/middlewares/o-auth/userAuth.js\");\n/* harmony import */ var _controllers_orders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/orders */ \"./src/controllers/orders/index.js\");\n\n\n\n\n\n\nconsole.log();\n\nconst router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\n\nrouter.get('/', _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _controllers_orders__WEBPACK_IMPORTED_MODULE_2__[\"getController\"]);\n\nrouter.post('/', _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _controllers_orders__WEBPACK_IMPORTED_MODULE_2__[\"postController\"]);\n\nrouter.get('/:orderId', _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _controllers_orders__WEBPACK_IMPORTED_MODULE_2__[\"getByIdController\"]);\n\nrouter.patch('/', _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _controllers_orders__WEBPACK_IMPORTED_MODULE_2__[\"patchController\"]);\n\nrouter.delete('/:orderId', _middlewares_o_auth_userAuth__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _controllers_orders__WEBPACK_IMPORTED_MODULE_2__[\"deleteController\"]);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n\n//# sourceURL=webpack:///./src/routes/orders.js?");
